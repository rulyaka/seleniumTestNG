...
public class DataDrivenTestDemo extends TestBase {
    ...
    public void testFullName() {
        extentLogger = report.createTest("Verify full name test");
        ...
        for (int i = 1; i < qa3Sheet.rowCount(); i++) {
            ...
            if (execute.equals("y")) {
                ...
                //write to skip to the result column of the same row
                qa3Sheet.setCellData("skip", "result", i);

            }
        }
        softAssert.assertAll(); // <<--- throws exertion if any of the soft assertion
    }
}
